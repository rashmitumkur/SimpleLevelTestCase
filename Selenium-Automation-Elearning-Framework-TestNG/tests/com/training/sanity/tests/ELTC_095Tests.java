...
public class ELTC_095Tests {
	...
	public void createaCourseTest(String userName, String password, String testName, String passPercentage, String questionName,
			String questionNameTwo) throws InterruptedException {
		...
		ELTC_062POM.sendTestName(testName);
		...
		ELTC_062POM.sendPassPercentage(passPercentage);
		...
		ELTC_062POM.sendQuestionName(questionName);
		...
		ELTC_062POM.sendQuestionNameTwo(questionNameTwo);
		...
		screenShot.captureScreenShot("ELTC_095_Screen1");
